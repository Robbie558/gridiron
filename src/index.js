...
const { getTeamLinks, getCurrentWeekScores, getHistoricPlayoffs, getHistoricWeekScores, getHistoricFinalStandings, getHistoricWeekTeamPoints, getHistoricRegularStandings } = require('./cheerio-functions.js');
...
app.get(`/api/:league_id/:year/:week/:team_id/bench`, (req, res) => {
    ...
    fetchProccessedCheerioData(targetUrl, getHistoricWeekTeamPoints, res);
});
...
app.get(`/api/:league_id/:year/:team_id/bench`, (req, res) => {
  ...
  historicalYearTeamBenchScore(seasonLengthUrl, targetUrl, res);
});